...
SeedHarvester::SeedHarvester(int gpin, int lfpin, int limitpin, int dirPin, int stepPin)
  : gpin_(gpin), lfpin_(lfpin), limitpin_(limitpin), dir_pin_(dirPin), step_pin_(stepPin) {
  pinMode(gpin_, OUTPUT);
  pinMode(lfpin_, OUTPUT);
